...
$checks = @(
    [pscustomobject]@{ File = (Join-Path $RepoRoot ".codex\README.md"); Patterns = @("impl-direction", "fix-direction", "UI", "Scenario", "Logic", "single-pass", "changes/", "tasks.md") },
    ...
    [pscustomobject]@{ File = (Join-Path $RepoRoot ".codex\skills\impl-direction\SKILL.md"); Patterns = @("docs/exec-plans/templates/impl-plan.md", "UI", "Scenario", "Logic", "impl-review", "reroute", "changes/", "tasks.md") },
    [pscustomobject]@{ File = (Join-Path $RepoRoot ".codex\skills\fix-direction\SKILL.md"); Patterns = @("docs/exec-plans/templates/fix-plan.md", "fix-distill", "fix-trace", "fix-logging", "fix-review", "tasks.md") },
    [pscustomobject]@{ File = (Join-Path $RepoRoot ".codex\skills\impl-review\SKILL.md"); Patterns = @("Review Scope", "pass", "reroute", "score") },
    [pscustomobject]@{ File = (Join-Path $RepoRoot ".codex\skills\fix-review\SKILL.md"); Patterns = @("Review Scope", "pass", "reroute", "score") },
    ...
    [pscustomobject]@{ File = (Join-Path $RepoRoot "docs\index.md"); Patterns = @("AGENTS.md", ".codex", "impl-direction", "fix-direction", "quality-score.md") },
    [pscustomobject]@{ File = (Join-Path $RepoRoot "docs\executable-specs.md"); Patterns = @("test", "acceptance checks", "Required Evidence", "UI", "Scenario", "Logic", "review") },
