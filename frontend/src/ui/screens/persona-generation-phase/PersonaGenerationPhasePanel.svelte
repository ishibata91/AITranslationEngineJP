...
>
  ...
  <section class="phase-controls-grid">
    <PhaseProgressPanel
      ...
      actionHintsTestId="persona-generation-phase-start-blocked-reason"
      onAction={(actionId) =>
    ...
    <AIModelSelectionCard
      ...
      statusTestId="persona-generation-phase-ai-settings-status-pill"
      statusTone={aiSettingsStatusTone}
      providerSelectId="personaPhaseProviderSelect"
      providerSelectTestId="persona-generation-phase-ai-provider-select"
      ...
      executionSelectTestId="persona-generation-phase-ai-execution-mode-select"
      ...
      modelSelectTestId="persona-generation-phase-ai-model-select"
