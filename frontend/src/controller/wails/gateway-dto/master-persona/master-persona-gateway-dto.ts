...
export type MasterPersonaPageRequestDto = MasterPersonaPageRequest
...
export type MasterPersonaUpdateRequestDto = MasterPersonaUpdateRequest
export type MasterPersonaDeleteRequestDto = MasterPersonaDeleteRequest
export type MasterPersonaMutationResponseDto = MasterPersonaMutationResponse
