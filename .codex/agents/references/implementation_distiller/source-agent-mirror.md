...
permissions: /Users/iorishibata/Repositories/AITranslationEngineJP/.codex/agents/references/implementation_distiller/permissions.json
contract: /Users/iorishibata/Repositories/AITranslationEngineJP/.codex/agents/references/implementation_distiller/contracts/implementation_distiller.contract.json
handoffs:
  - label: Return to orchestrator
    agent: implementation_orchestrator
    prompt: implementation_distiller contract の output fields を implementation_orchestrator の completion packet 材料として返す。
    send: false
---
...
この作業は `implementation_distiller` agent 定義に基づく。
`single_handoff_packet` 1 件から、implementation_implementer が読む `lane_context_packet` と implementation_tester が読む `implementation_tester_context_packet` を作る。
...
- implementation_tester 向けには `implementation_tester_context_packet` を別に作り、test_ingredients、test_required_reading、test_validation_entry に圧縮する。
- implementation_tester には fix_ingredients、change_targets、broad related_code_pointers を丸ごと渡さない。
...
- 要件、実装方針、決定事項は要約し、implementation_implementer に原文再読を丸投げしない。
...
10. implementation_tester 用の public seam、既存 test target、fixture/helper、assertion focus、focused validation を implementation_tester_context_packet に分ける。
11. lane_context_packet、implementation_tester_context_packet、implementation_facts、constraints、gaps、required_reading を分ける。
...
正本は [permissions.json](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/agents/references/implementation_distiller/permissions.json) とする。
本文には要約だけを書く。
...
正本は [implementation_distiller.contract.json](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/agents/references/implementation_distiller/contracts/implementation_distiller.contract.json) とする。
...
- 渡す contract: [implementation_distiller.contract.json](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/agents/references/implementation_distiller/contracts/implementation_distiller.contract.json)
- 渡す scope: lane_context_packet、implementation_tester_context_packet、remaining gaps
