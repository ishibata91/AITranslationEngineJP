...
- エージェント実行定義とツール権限は [scenario_state_transition_generator.toml](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/agents/scenario_state_transition_generator.toml) の `allowed_write_paths` / `allowed_commands` とする。
...
- 候補 artifact: `docs/exec-plans/active/<task-id>/scenario-candidates.state-transition.md` を返す。
