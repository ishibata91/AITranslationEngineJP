...
- `implementation-review`: 実装差分が implementation-scope artifact または accepted fix scope と整合するか確認する
...
- `implementation-review` は implementation-scope artifact や accepted fix scope にない仕様や好みで判定しない
