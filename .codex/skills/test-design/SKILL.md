...
- 不足テストテンプレートは [missing-tests.md](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/skills/test-design/assets/missing-tests.md) とする。
- 不足UCテンプレートは [missing-usecases.md](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/skills/test-design/assets/missing-usecases.md) とする。
- 不足セレクタテンプレートは [missing-selectors.md](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/skills/test-design/assets/missing-selectors.md) とする。
