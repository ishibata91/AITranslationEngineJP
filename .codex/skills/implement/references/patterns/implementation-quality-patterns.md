...
`implementation_implementer` が owned_scope 内で product code を実装するための品質判断パターンをまとめる。
...
- product test、fixture、snapshot、test helper を implementation_implementer が変更している。
