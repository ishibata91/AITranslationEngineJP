...
- agent runtime と tool policy は [scenario_actor_goal_generator.toml](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/agents/scenario_actor_goal_generator.toml) の `allowed_write_paths` / `allowed_commands` とする。
