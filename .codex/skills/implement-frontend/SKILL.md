...
description: Codex implementation lane 側の frontend 実装知識 package。画面導線、state、Wails bridge の判断基準を提供する。
---
...
- [implement-frontend-checklist.md](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/skills/implement-frontend/references/checklists/implement-frontend-checklist.md) を参照する。
