---
name: tests-scenario
description: Codex implementation lane 側の scenario artifact を product test に反映する知識 package。
---
...
- [tests-scenario-checklist.md](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/skills/tests-scenario/references/checklists/tests-scenario-checklist.md) を参照する。
