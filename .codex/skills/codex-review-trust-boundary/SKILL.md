...
- エージェント実行定義とツール権限は [review_trust_boundary.toml](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/agents/review_trust_boundary.toml) の `allowed_write_paths` / `allowed_commands` とする。
...
- 対象 review 観点の指摘、安全性評価、根拠、残留リスクが返却されている。
