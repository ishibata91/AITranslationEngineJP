...
7. 実装後は project root で `sonar-scanner` を実行し、`python3 .codex/skills/directing-implementation/scripts/get-open-sonar-issues.py --project ishibata91_AITranslationEngineJP` で `status == OPEN` issue を取得する。
