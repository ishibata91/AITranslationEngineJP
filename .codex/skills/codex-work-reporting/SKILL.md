...
- Codex run の 終了処理、停止、戻し を記録する時
- Codex implementation レーン 完了根拠 を受けて、または Codex implementation レーン 会話ログ から抽出して `codex.md` へ転記する時
- `analysis/benchmark-score.json` から run 全体ベンチマーク を作る時
