...
- agent runtime と tool policy は [scenario_operation_audit_generator.toml](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/agents/scenario_operation_audit_generator.toml) の `allowed_write_paths` / `allowed_commands` とする。
