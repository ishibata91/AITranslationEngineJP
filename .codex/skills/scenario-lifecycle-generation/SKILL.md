...
- エージェント実行定義とツール権限は [scenario_lifecycle_generator.toml](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/agents/scenario_lifecycle_generator.toml) の `allowed_write_paths` / `allowed_commands` とする。
...
- 候補 artifact: `docs/exec-plans/active/<task-id>/scenario-candidates.lifecycle.md` を返す。
