...
- 着手前に `../orchestrating-fixes/references/orchestrating-fixes.to.implementing-fixes.json` を参照して入力契約を確認する。
- `orchestrating-fixes` へ返す時は `references/implementing-fixes.to.orchestrating-fixes.json` を返却契約として使う。
