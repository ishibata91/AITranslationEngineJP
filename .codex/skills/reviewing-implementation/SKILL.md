...
- score を返さない
- 好みや美しさを主目的にしない
- `python3 .codex/skills/directing-implementation/scripts/get-open-sonar-issues.py --project ishibata91_AITranslationEngineJP` が Docker MCP Sonar issue gate で open issue 0 件を返した後だけ review に入る
- 重大不足があれば lane へ差し戻す
