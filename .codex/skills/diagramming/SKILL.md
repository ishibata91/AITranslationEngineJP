...
3. PlantUML や library の書き方が関係する場合は `npx ctx7 library` / `npx ctx7 docs` で確認する。
...
- explicit helper contract: [diagrammer.contract.json](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/agents/references/diagrammer/contracts/diagrammer.contract.json)
