...
- 詳細仕様差分雛形: [detail-spec-diff.md](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/skills/detail-spec-design/assets/detail-spec-diff.md)
- 実行定義 skill: [design-bundle](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/skills/design-bundle/SKILL.md)
...
- コンポーネント図以外の図は、ユーザー要求または複雑性がある時だけ作る。
...
- 完了判断材料として、`implement_lane` が人間レビュー、実装範囲作成、正本化判断を判断できる情報が返っている。
