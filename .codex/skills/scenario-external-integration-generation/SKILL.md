...
- agent runtime と tool policy は [scenario_external_integration_generator.toml](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/agents/scenario_external_integration_generator.toml) の `allowed_write_paths` / `allowed_commands` とする。
