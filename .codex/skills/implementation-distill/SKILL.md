...
description: Codex implementation lane 側の実装前文脈整理の共通知識 package。single_handoff_packet 1 件から実装に必要な facts を圧縮する判断基準を提供する。
---
...
tool policy は [implementation_distiller.toml](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/agents/implementation_distiller.toml) が持ち、active contract と handoff は contract / skill に従う。
...
- [implementation-distill-implement](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/skills/implementation-distill-implement/SKILL.md): 新機能や拡張の実装前 context
- [implementation-distill-fix](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/skills/implementation-distill-fix/SKILL.md): fix scope、再現証跡、修正対象
- [implementation-distill-refactor](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/skills/implementation-distill-refactor/SKILL.md): 不変条件、依存境界、preserved behavior
...
- [context-compression-patterns.md](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/skills/implementation-distill/references/patterns/context-compression-patterns.md) を参照する。
...
- [implementation-distill-checklist.md](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/skills/implementation-distill/references/checklists/implementation-distill-checklist.md) を参照する。
- checklist は知識確認用であり、実行義務は agent contract が決める。

## Agent が持つもの

- active contract: [implementation_distiller.contract.json](/Users/iorishibata/Repositories/AITranslationEngineJP/.codex/agents/references/implementation_distiller/contracts/implementation_distiller.contract.json)
