...
1. `docs/index.md` から、対象タスクに関係する文書だけを確認する
2. 既存の active / completed plan に同種タスクがないか確認する
3. `powershell -File scripts/harness/run.ps1 -Suite structure` を実行する
4. 文書契約や役割契約に触れるなら `powershell -File scripts/harness/run.ps1 -Suite design` も実行する
