...
-- key は文体（説明体/書物体/日記体/世界観断片）・口調・固有名・定型句。複数 REC:FIELD が 1 directive を共有する。
...
-- 7 指示文を seed する。既に行があれば書き換えない（編集結果を保つ）。
...
INSERT OR IGNORE INTO directive (key, instruction, variables) VALUES
    ('説明体', 'これは装備・呪文・効果などの説明文です。性能や効果を正確に保ち、簡潔で読みやすい説明口調の日本語へ訳すこと。', '[]'),
    ('書物体', 'これは書物の本文です。文章の格調と語り口を保ち、読み物として自然な日本語へ訳すこと。', '[]'),
    ('日記体', 'これはクエストの進行ログまたは目標です。主人公の視点で、簡潔な記録口調の日本語へ訳すこと。', '[]'),
    ('世界観断片', 'これはロード画面の世界観解説です。簡潔で含みのある説明口調の日本語へ訳すこと。', '[]'),
    ('口調', 'この台詞の話者の人物像:
{traits}
この人物像に合う口調と人称で訳すこと。', '[{"token":"{traits}","description":"話者の性質（生成済みの基底口調と種族訛り）"}]'),
    ('固有名', 'これは固有名詞です。文脈に依存しない簡潔な訳とし、既存の確定訳語があればそれに合わせること。', '[]'),
    ('定型句', 'これは UI やオブジェクト操作などの定型的な短い語句です。簡潔で一般的な日本語へ訳すこと。', '[]');
...
INSERT OR IGNORE INTO record_type_master (rec, field, box, directive, logical_name) VALUES
    -- 叙述文（説明体）: 装備・消耗品・呪文・付呪・特典・効果・種族・メッセージの説明文。
    ('WEAP', 'DESC', '叙述文', '説明体', '武器の説明'),
    ('ARMO', 'DESC', '叙述文', '説明体', '防具の説明'),
    ('AMMO', 'DESC', '叙述文', '説明体', '矢弾の説明'),
    ('ALCH', 'DESC', '叙述文', '説明体', '薬・食料の説明'),
    ('SCRL', 'DESC', '叙述文', '説明体', '巻物の説明'),
    ('INGR', 'DESC', '叙述文', '説明体', '錬金素材の説明'),
    ('SPEL', 'DESC', '叙述文', '説明体', '呪文の説明'),
    ('ENCH', 'DESC', '叙述文', '説明体', '付呪効果の説明'),
    ('PERK', 'DESC', '叙述文', '説明体', '特典の説明'),
    ('SHOU', 'DESC', '叙述文', '説明体', 'シャウトの説明'),
    ('MGEF', 'DNAM', '叙述文', '説明体', '魔法効果の説明'),
    ('MESG', 'DESC', '叙述文', '説明体', 'メッセージ本文'),
    ('RACE', 'DESC', '叙述文', '説明体', '種族の説明'),
    -- 叙述文（書物体）: 本の本文。
    ...
    -- 定型句: オブジェクト操作・ボタン・龍語の語義など、文脈で訳が変わらない非固有名の短文。
    ('ACTI', 'RNAM', '定型句', '定型句', 'オブジェクトの操作名'),
    ('FLOR', 'RNAM', '定型句', '定型句', '採取植物の操作名'),
    ('TREE', 'RNAM', '定型句', '定型句', '樹木の操作名'),
    ('MESG', 'ITXT', '定型句', '定型句', 'メッセージのボタン'),
    ('WOOP', 'TNAM', '定型句', '定型句', '龍語の語義'),
