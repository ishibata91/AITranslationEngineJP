...
INSERT OR IGNORE INTO directive (key, instruction, variables) VALUES
    ('物品説明', 'これは武器・防具・薬・巻物などの品物の説明文です。用途と特徴を正確に保ち、簡潔で読みやすい説明口調の日本語へ訳すこと。', '[]'),
    ('効果説明', 'これは呪文・付呪・特典・シャウト・魔法効果の説明文です。数値と <> で囲まれた実行時タグは原文のまま残し、増減や順序を変えないこと。体言止めで短くまとめること。', '[]'),
    ('世界観断片', 'これはロード画面や種族の解説です。作品世界を語る地の文として、簡潔で含みのある説明口調の日本語へ訳すこと。', '[]'),
    ('書物体', 'これは書物の本文です。文章の格調と語り口を保ち、読み物として自然な日本語へ訳すこと。', '[]'),
    ('日記体', 'これはクエストの進行ログまたは目標です。主人公の視点で、簡潔な記録口調の日本語へ訳すこと。', '[]'),
    ('固有名', 'これは固有名詞です。カタカナ音写を基本とし、意味訳へ置き換えないこと。ゲーム UI に収まるよう、原語より長くしないこと。既存の確定訳語があればそれに合わせること。', '[]'),
    ('操作名', 'これは調べる・採取するなどの操作を表す短い語句です。動詞の終止形で短く訳し、UI の表示幅に収まる長さにすること。', '[]'),
    ('語義', 'これは龍語など、語そのものの意味を述べる語釈です。語の意味を短く言い切る名詞句または短文で訳すこと。説明を足さないこと。', '[]'),
    ('口調', 'この台詞の話者の人物像:
{traits}
