...
-- 口調の文面は 2026-07-28 に更新した。実験 task dialogue-tone-naturalness が、公式日本語既訳と
-- 見分けにくくなる形を 25 回の測定で決めた。既に行がある DB は 0017 が UPDATE で揃える。
...
1 つの台詞に文が 2 つ以上ある時は、句点でつなげず全角空白で区切る。', '[{"token":"{traits}","description":"話者の性質（生成済みの基底口調と種族訛り）"}]');
