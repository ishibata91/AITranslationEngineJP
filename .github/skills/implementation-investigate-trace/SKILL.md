...
description: GitHub Copilot 側の実装中 trace 知識 package。
---
...
`investigator` agent が実装中の原因候補、観測点、不足情報を整理する時の判断基準を提供する。
...
- [implementation-investigate-trace-checklist.md](/Users/iorishibata/Repositories/AITranslationEngineJP/.github/skills/implementation-investigate-trace/references/checklists/implementation-investigate-trace-checklist.md) を参照する。
